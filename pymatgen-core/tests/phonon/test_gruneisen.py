...
class TestGruneisenPhononBandStructureSymmLine(PymatgenTest):
    def setUp(self) -> None:
        get_gruneisen_ph_bs_symm_line = pytest.importorskip("pymatgen.io.phonopy.get_gruneisen_ph_bs_symm_line")
...
class TestGruneisenParameter(PymatgenTest):
    def setUp(self) -> None:
        get_gruneisenparameter = pytest.importorskip("pymatgen.io.phonopy.get_gruneisenparameter")
